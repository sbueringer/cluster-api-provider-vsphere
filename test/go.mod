...
replace sigs.k8s.io/cluster-api => sigs.k8s.io/cluster-api v1.6.0-rc.0.0.20240205104749-1922064821c4

replace sigs.k8s.io/cluster-api/test => sigs.k8s.io/cluster-api/test v1.6.0-rc.0.0.20240205104749-1922064821c4
